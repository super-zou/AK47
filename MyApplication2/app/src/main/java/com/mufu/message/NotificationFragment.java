...
import com.mufu.R;
import com.mufu.adapter.NotificationListAdapter;
...
import static com.mufu.util.ParseUtils.APPLY_JOIN_GROUP_NF;
import static com.mufu.util.ParseUtils.AUTHENTICATION_VERIFIED_NF;
import static com.mufu.util.ParseUtils.COMMENT_PRAISED_NF;
...
import static com.mufu.util.ParseUtils.PRAISE_MEET_COMMENT_NF;
import static com.mufu.util.ParseUtils.REPLY_PRAISED_NF;
...
public class NotificationFragment extends BaseFragment {
    ...
    protected void initView(View view) {
        ...
        notificationListAdapter = new NotificationListAdapter(getContext(), getFragmentManager());
