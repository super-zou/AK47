...
public class TalentRequestListAdapter extends RecyclerView.Adapter<TalentRequestListAdapter.ViewHolder> {
    ...
    public TalentRequestListAdapter(Context context) {
        mContext = context;
    }

    public static void setContentView(TalentRequestListAdapter.ViewHolder holder, SubGroupActivity.Talent talent) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TalentRequestListAdapter.ViewHolder holder, final int position) {
    ...
    public void setOnItemClickListener(VerifyOperationInterface verifyOperationInterface, TalentRequestListAdapter.MyItemClickListener myItemClickListener) {
