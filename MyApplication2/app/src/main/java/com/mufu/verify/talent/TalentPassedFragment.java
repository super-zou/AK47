...
import com.mufu.R;
import com.mufu.adapter.verify.TalentPassedtListAdapter;
...
import static com.mufu.verify.talent.TalentRejectedFragment.getTalentById;
import static com.mufu.verify.talent.TalentVerifyActivity.LOAD_TALENT_DONE;
...
public class TalentPassedFragment extends BaseFragment {
    ...
    private TalentPassedtListAdapter talentPassedtListAdapter;
    private MyHandler handler;
    private TalentPassedBroadcastReceiver mReceiver;
    ...
    protected void initView(View view) {
        ...
        talentPassedtListAdapter = new TalentPassedtListAdapter(getContext());
        ...
        xRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                if (newState == SCROLL_STATE_IDLE) {
                    talentPassedtListAdapter.setScrolling(false);
                    talentPassedtListAdapter.notifyDataSetChanged();
                } else {
                    talentPassedtListAdapter.setScrolling(true);
                }
        ...
        talentPassedtListAdapter.setOnItemClickListener(new VerifyOperationInterface() {
            @Override
        ...
        }, new TalentPassedtListAdapter.MyItemClickListener() {
            @Override
        ...
        xRecyclerView.setAdapter(talentPassedtListAdapter);
    ...
    protected void requestData() {
        ...
        String url = GET_ALL_VERIFY_TALENTS + "/passed";
        RequestBody requestBody = builder.build();
    ...
    public void handleMessage(Message message) {
        switch (message.what) {
            ...
            case OPERATION_PASSED_DONE:
                ...
                talentPassedtListAdapter.notifyItemRangeRemoved(mCurrentPos, 1);
                talentPassedtListAdapter.notifyDataSetChanged();
            ...
            case LOAD_TALENT_DONE:
                ...
                talentPassedtListAdapter.setData(talentList);
                talentPassedtListAdapter.notifyItemInserted(0);
                talentPassedtListAdapter.notifyDataSetChanged();
                break;
            default:
                break;
    ...
    private class TalentPassedBroadcastReceiver extends BroadcastReceiver {
        @Override
    ...
    private void registerBroadcast() {
        mReceiver = new TalentPassedBroadcastReceiver();
    ...
    static class MyHandler extends Handler {
        WeakReference<TalentPassedFragment> talentRequestFragmentWeakReference;

        MyHandler(TalentPassedFragment talentRequestFragment) {
            talentRequestFragmentWeakReference = new WeakReference<>(talentRequestFragment);
        }

        @Override
        public void handleMessage(Message message) {
            TalentPassedFragment talentRequestFragment = talentRequestFragmentWeakReference.get();
