...
import static com.mufu.main.DynamicFragment.GET_MY_NEW_ADD_DONE;
import static com.mufu.main.DynamicFragment.GET_MY_NEW_ADD_DYNAMICS_URL;

/**
 * Created by haichao.zou on 2017/11/20.
 */
 
 public class EdenGardenFragment extends BaseFragment implements CommonDialogFragmentInterface{
    ...
    protected int getLayoutId() {
        int layoutId = R.layout.eden_garden_fragment;
        return layoutId;
    }
    ...
    protected void initView(View convertView) {
        ...
        meetDynamicsListAdapter.setOnCommentClickListener(new InterActInterface() {
            ...
            public void onOperationClick(View view, int position) {
                ...
                dynamicOperationDialogFragment.setTargetFragment(EdenGardenFragment.this, REQUEST_CODE);
        ...
        final Button dynamicCreateBtn = convertView.findViewById(R.id.dynamic_create_btn);
        
        dynamicCreateBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MyApplication.getContext(), AddDynamicsActivity.class);
                intent.putExtra("type", ParseUtils.EDEN_GARDEN_DYNAMIC);
    ...
    private void getMyNewActivity() {
        requestBody = new FormBody.Builder()
                .add("type", String.valueOf(ParseUtils.EDEN_GARDEN_DYNAMIC))
    ...
    static class MyHandler extends Handler {
        WeakReference<EdenGardenFragment> meetDynamicsFragmentWeakReference;

        MyHandler(EdenGardenFragment shareFragment) {
            meetDynamicsFragmentWeakReference = new WeakReference<EdenGardenFragment>(shareFragment);
        }

        @Override
        public void handleMessage(Message message) {
            EdenGardenFragment mShareFragment = meetDynamicsFragmentWeakReference.get();
