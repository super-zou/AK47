 ...
 public class DynamicsListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof DynamicViewHolder){
            ...
            }else if (holder instanceof SingleGroupViewHolder){
            onSingleGroupActionBindViewHolder((SingleGroupViewHolder)holder, position);
    ...
    public void onSingleGroupActionBindViewHolder(final SingleGroupViewHolder holder, final int position) {
        if (isDebug) Slog.d(TAG, "-------->onSingleGroupActionBindViewHolder position: "+position);
        final Dynamic dynamic = dynamicList.get(position);
        setAuthorProfile(holder.authorProfileVH, dynamic);
        ...
        setRelatedSingleGroupContentView(holder.singleGroupViewHolder, dynamic);
        onDynamicsItemElementClick(holder.baseProfile, dynamic);
        holder.relativeContentWrapper.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void setRelatedSingleGroupContentView(MeetSingleGroupSummaryAdapter.ViewHolder holder, Dynamic dynamic){
    ...
    public static class CommonViewHolder extends RecyclerView.ViewHolder {
        ...
        public CommonViewHolder(View view) {
            ...
            baseProfile = view.findViewById(R.id.base_profile);
            authorProfileVH = new AuthorProfileVH(view);
            authorContent = (TextView) view.findViewById(R.id.author_content);
