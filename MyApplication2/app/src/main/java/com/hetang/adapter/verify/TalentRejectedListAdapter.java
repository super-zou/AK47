...
public class TalentRejectedListAdapter extends RecyclerView.Adapter<TalentRejectedListAdapter.ViewHolder> {
    ...
    public TalentRejectedListAdapter(Context context) {
        mContext = context;
    }

    public static void setContentView(TalentRejectedListAdapter.ViewHolder holder, SubGroupActivity.Talent talent) {
        ...
        if (holder.reason.getVisibility() == View.GONE){
            holder.reason.setVisibility(View.VISIBLE);
        }
        holder.reason.setText(talent.reason);
    ...
    @Override
    public void onBindViewHolder(@NonNull TalentRejectedListAdapter.ViewHolder holder, final int position) {
    ...
    public void setOnItemClickListener(VerifyOperationInterface verifyOperationInterface, TalentRejectedListAdapter.MyItemClickListener myItemClickListener) {
