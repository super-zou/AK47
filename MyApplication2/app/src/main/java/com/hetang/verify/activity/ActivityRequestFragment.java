...
import com.hetang.R;
import com.hetang.adapter.verify.TalentRequestListAdapter;
...
public class ActivityRequestFragment extends BaseFragment {
    ...
    private List<ActivityRequestFragment.Authentication> authenticationList = new ArrayList<>();
    private XRecyclerView xRecyclerView;
    private TalentRequestListAdapter authenticationListAdapter;
    ...
    protected void initView(View view) {
        ...
        authenticationListAdapter = new TalentRequestListAdapter(getContext());
    ...
    public void handleMessage(Message message) {
        switch (message.what) {
            case LOAD_DONE:
                //authenticationListAdapter.setData(authenticationList, REQUEST);
                authenticationListAdapter.notifyDataSetChanged();
    ...
    static class MyHandler extends Handler {
        WeakReference<ActivityRequestFragment> notificationFragmentWeakReference;

        MyHandler(ActivityRequestFragment notificationFragment) {
            notificationFragmentWeakReference = new WeakReference<>(notificationFragment);
        }

        @Override
        public void handleMessage(Message message) {
            ActivityRequestFragment notificationFragment = notificationFragmentWeakReference.get();
