...
public class CalendarView extends LinearLayout {
    ...
    private void initTime(Context context, String time) {
        if (!time.equals("")) {
            curDate = DateUtil.strToCalendar(time, com.hetang.common.constant.CommonConstant.TFORMATE_YMD);
            dateFromServer = DateUtil.strToDate(time, com.hetang.common.constant.CommonConstant.TFORMATE_YMD);
        } else {
