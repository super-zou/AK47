...
public class ExperienceSummaryActivity extends BaseAppCompatActivity implements CommonDialogFragmentInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.experience_summary);
    ...
    private void initView() {
        ...
        handler = new ExperienceSummaryActivity.MyHandler(this);
        recyclerView = findViewById(R.id.experience_summary_list);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MyApplication.getContext(), GuideSummaryActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_EXCLUDE_FROM_RECENTS);
    ...
    private void setMyGroupView() {
        ...
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, WRAP_CONTENT);
    ...
    private void setRecommendTalentsHeader() {
        ...
        moreTalent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ExperienceSummaryActivity.this, TalentSummaryListActivity.class);
                intent.putExtra("type", type);
                startActivity(intent);
            }
        });
    ...
    private void setSingleGroupHeader() {
        ...
        moreTalent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ExperienceSummaryActivity.this, SingleGroupActivity.class);
                startActivity(intent);
            }
        });
    ...
    static class MyHandler extends Handler {
        WeakReference<ExperienceSummaryActivity> subGroupActivityWeakReference;

        MyHandler(ExperienceSummaryActivity subGroupActivity) {
            subGroupActivityWeakReference = new WeakReference<ExperienceSummaryActivity>(subGroupActivity);
        }

        @Override
        public void handleMessage(Message message) {
            ExperienceSummaryActivity subGroupActivity = subGroupActivityWeakReference.get();
