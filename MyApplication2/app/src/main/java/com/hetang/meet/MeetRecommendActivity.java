...
public class MeetRecommendActivity extends BaseAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.meet_recommend);
    ...
    private void setMeetHeaderView() {
        lookFriend = LayoutInflater.from(getContext()).inflate(R.layout.look_friend, (ViewGroup) findViewById(android.R.id.content), false);
    ...
    static class MyHandler extends HandlerTemp<MeetRecommendActivity> {

        public MyHandler(MeetRecommendActivity cls) {
            super(cls);
        }
        ...
        public void handleMessage(Message message) {
            ...
            MeetRecommendActivity meetRecommendActivity = ref.get();
