...
import com.hetang.R;
import com.hetang.widget.PicturePreviewViewPager;
...
public class PicturePreviewActivity extends PictureBaseActivity implements View.OnClickListener {
    ...
    private PicturePreviewViewPager viewPager;
    ...
    private PicturePreviewActivity.loadDataThread loadDataThread;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.content_picture_preview);
        inflater = LayoutInflater.from(this);
        tv_title = (TextView) findViewById(R.id.picture_title);
        left_back = (Button) findViewById(R.id.left_back);
        viewPager = (PicturePreviewViewPager) findViewById(R.id.preview_pager);
    ...
    public class SimpleFragmentAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            // 长图控件
            final SubsamplingScaleImageView longImg = (SubsamplingScaleImageView) contentView.findViewById(com.luck.picture.lib.R.id.longImg);
                ...
                imageView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        if (rxPermissions == null) {
                            rxPermissions = new RxPermissions(PicturePreviewActivity.this);
                        }
    ...
    private void showDownLoadDialog(final String path) {
        final CustomDialog dialog = new CustomDialog(PicturePreviewActivity.this,
                ScreenUtils.getScreenWidth(PicturePreviewActivity.this) * 3 / 4,
                ScreenUtils.getScreenHeight(PicturePreviewActivity.this) / 4,
                com.luck.picture.lib.R.layout.picture_wind_base_dialog_xml, com.luck.picture.lib.R.style.Theme_dialog);
        TextView btn_cancel =  dialog.findViewById(com.luck.picture.lib.R.id.btn_cancel);
        ...
        btn_commit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean isHttp = PictureMimeType.isHttp(path);
                if (isHttp) {
                    loadDataThread = new PicturePreviewActivity.loadDataThread(path);
                    loadDataThread.start();
                } else {
                    // 有可能本地图片
                    try {
                        String dirPath = PictureFileUtils.createDir(PicturePreviewActivity.this,
    ...
    public void showLoadingImage(String urlPath) {
        try {
            ...
            String path = PictureFileUtils.createDir(PicturePreviewActivity.this,
                    System.currentTimeMillis() + ".png", directory_path);
