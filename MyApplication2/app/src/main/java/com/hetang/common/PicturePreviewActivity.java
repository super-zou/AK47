                        ...
                        longImageView.setOnLongClickListener(v -> {
                            if (config.isNotPreviewDownload) {
                                if (PermissionChecker.checkSelfPermission(getContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                                    ...
                                    PermissionChecker.requestPermissions(PicturePreviewActivity.this,
    ...
    private void showDownLoadDialog() {
        if (!isFinishing() && !TextUtils.isEmpty(downloadPath)) {
            ...
            btn_commit.setOnClickListener(view -> {
                ...
                showPleaseDialog();
                if (isHttp) {
                    mLoadDataThread = new PicturePreviewActivity.LoadDataThread(downloadPath);
